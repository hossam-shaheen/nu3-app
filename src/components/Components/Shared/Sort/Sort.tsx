...
export const Sort: FunctionComponent<{ onSort: SortProps["onSort"] }> = ({
  onSort,
}): JSX.Element => {
  ...
  return (
    <div className={classes.sort}>
      ...
      >
        <option value={"Random"} data-testid="sort-select-option">
          Random
        </option>
        <option value={"Alphabetical"} data-testid="sort-select-option">
          Alphabetical
        </option>
        <option value={"Low"} data-testid="sort-select-option">
          Price: Low to High
        </option>
        <option value={"High"} data-testid="sort-select-option">
          Price: High to Low
        </option>
      </select>
    </div>
